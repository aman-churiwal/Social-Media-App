...
import com.aman.socialmedia.daos.UserDao
import com.aman.socialmedia.models.User
...
class SignInActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val signInRequest = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
            ...
            .requestIdToken("614139050290-3qqui8v3jemddi1mi07kltolbcup1e9u.apps.googleusercontent.com")
